    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('admin.users.index') }}">المشرفين</a></li>
                    ...
                    <form action="{{ route('admin.users.update', $user->id ) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                @php
                                    $models = ['users', 'foods','chefs','reservations','orders','pilots'];
                             ...
                             <div class="form-group">
                                ...
                                <select name="user_type" class="form-control" required>
                                    <option value="0" {{ $user->user_type == '0'?'selected':'' }}>مستخدم</option>
                                    <option value="1" {{ $user->user_type == '1'?'selected':'' }}>مشرف</option>
                                </select>
                            </div>
