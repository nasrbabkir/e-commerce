    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">ارشقةالطلبات</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">ارشقة الطلبات <small></small></h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (auth()->user()->hasPermission('orders_update'))
                                            <a href="{{ route('admin.archives.show', $order->id) }}" class="warring-matrial btn btn-sm " id="#"><i class="fa fa-edit"></i> عرض</a>
                                        @else
